...
import static Project.Platnosc.*;
...
/*<- tu trzeba wpisać ciało metody *//*
    ...
    public static void main(String[] args) {
        ...
        cennik.dodaj(KROTKI, "5GB", 20, 15, 10, 3); 	// 20 zł za 1 okres (jednorazowy),
        ...
        cennik.dodaj(SREDNI, "10GB", 25, 20, 2);	// 25 zł za 1 okres (jeśli klient zakupi do 2 kolejnych okresów),
        // 20 zł za 1 okres (jeśli klient zakupi od 3 kolejnych okresów)

        cennik.dodaj(DLUGI, "30GB", 35, 30);		// 30 zł za 1 okres jeśli klient ma abonament,
